...
contract ECToken  {
    ...
    string public constant symbol = "ECDMT";
    ...
    function allowance(address _owner, address spender) returns (uint256 remaining) {
    ...
    function transferFrom(address _from, address _to, uint256 _value) returns (bool success) {
        if ((_value <= 0) || (_value > 0 && balances[from] < _value)) {
            return false;
        }
